...
<html>
	...
	<body ng-app="photoPrints">
									...
									<div class="item-list-table">
										...
										<table class="data-clickable">
										    <tbody>
										        ...
										        <tr ng-repeat="i in items" data-id="{{x.id}}">
										            <td>{{i.name}}</td>
										            <td>{{i.item_code}}</td>
										            <td>{{i.category_fk}}</td>
		...
		<script src="/js/angularFiles/services.js"></script>
		<script src="/js/angularFiles/directives.js"></script>
		<script src="/js/angularFiles/filters.js"></script>
		<script src="/js/angularFiles/controllers.js"></script>
